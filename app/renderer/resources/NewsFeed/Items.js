...
export default [
  {
    ...
    title: "Support PoE Live Search Manager",
    link: "https://github.com/sponsors/thisismydesign",
    description: `Keep the tool alive and growing! In the past year, new features were created by paid developers. You can now support us via the [Sponsor button](https://github.com/sponsors/thisismydesign) on [GitHub](https://github.com/5k-mirrors/poe-live-search-manager).
