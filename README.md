...
*You are viewing the README of version [v1.0.0](https://github.com/thisismydesign/poe-sniper/releases/tag/v1.0.0) which is a completely new app with [pathofexile.com/trade](https://www.pathofexile.com/trade/search/) support and a graphical interface. GitHub is only used to host releases and issues. You can find other releases [here](https://github.com/thisismydesign/poe-sniper/releases). The old app is available in [v0.6.0](https://github.com/5k-mirrors/poe-sniper/tree/v0.6.0).*
